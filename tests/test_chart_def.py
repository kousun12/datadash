...
def test_save_and_load(tmp_path, sample_chart_def):
    ...
    # Load it back
    chart_dir = tmp_path / "sessions" / sample_chart_def.table_name / sample_chart_def.id
...
def test_save_and_load_with_dataframe(tmp_path, sample_chart_def):
    ...
    pd.testing.assert_frame_equal(
        loaded_def.dataframe,
        sample_chart_def.dataframe
    )
